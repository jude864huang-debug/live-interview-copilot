...
struct IdleHomeDashboardView: View {
            ...
            if !settings.calendarIntegrationEnabled {
                ...
                case .authorized:
                    if events.isEmpty && earlierTodayEvents.isEmpty {
                        emptyStateCard(
                            ...
                            description: "Live Interview Copilot will show your next calendar meetings here."
                        )
                    } else {
                ...
                case .notDetermined:
                    emptyStateCard(
                        ...
                        description: "Live Interview Copilot will show your upcoming meetings once Calendar access is granted."
                    )
                }
            }
        }
    ...
    private var disabledCalendarCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("Enable Calendar integration to see the meetings LiveInterviewCopilot can prepare for.")
                .font(.system(size: 13))
