...
struct CalendarSettingsTab: View {
    ...
    private var calendarsCard: some View {
        settingsCard {
            ...
            Text("Choose which calendars LiveInterviewCopilot can use when matching meetings.")
                .font(.system(size: 11))
                .foregroundStyle(.secondary)
    ...
    private var accessDetail: some View {
        ...
        case .denied:
            VStack(alignment: .leading, spacing: 6) {
                Text("Calendar access is denied. Grant access in System Settings for LiveInterviewCopilot to see your events.")
                    .font(.system(size: 11))
                    .foregroundStyle(.secondary)
        ...
        case .notDetermined:
            Text("Live Interview Copilot will request Calendar access when this setting is enabled.")
                .font(.system(size: 11))
                .foregroundStyle(.secondary)
        }
    }
