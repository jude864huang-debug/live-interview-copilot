...
struct RecordingConsentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("""
            LiveInterviewCopilot records and transcribes audio from your microphone \
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                consentBullet("The developers of LiveInterviewCopilot accept no liability for unauthorized or unlawful recording.")
            }
