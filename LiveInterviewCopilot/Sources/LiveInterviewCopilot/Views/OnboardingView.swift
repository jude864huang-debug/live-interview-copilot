...
struct OnboardingView: View {
    ...
    private let steps: [(icon: String, title: String, body: String)] = [
        (
            "waveform.circle",
            "Welcome to LiveInterviewCopilot",
        ...
        (
            "lightbulb",
            "AI Suggestions",
            "As the conversation progresses, LiveInterviewCopilot pulls relevant context from your knowledge base and suggests talking points. The best suggestions surface automatically."
        ),
        (
