...
struct HomeTimelineWorkspaceView: View {
    ...
    private func workspace(controller: NotesController, accessState: CalendarManager.AccessState) -> some View {
        ...
        HStack(spacing: 0) {
            ...
            .frame(
                minWidth: LiveInterviewCopilotWindowSizing.homeTimelinePaneMinWidth,
            ...
            if isDetailVisible {
                ...
                detailPane(controller: controller)
                    .frame(
                        minWidth: LiveInterviewCopilotWindowSizing.meetingDetailPaneMinWidth,
                        maxWidth: .infinity,
                        maxHeight: .infinity
                    )
    ...
    private func calendarAccessNotice(
        ...
        if !settings.calendarIntegrationEnabled {
            ...
            HomeTimelineNotice(
                ...
                message: "Saved meetings are still available while LiveInterviewCopilot waits for Calendar access.",
                actionTitle: nil,
                action: nil
            )
        }
