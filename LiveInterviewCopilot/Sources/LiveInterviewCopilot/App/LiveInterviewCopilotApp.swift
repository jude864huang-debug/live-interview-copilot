...
enum LiveInterviewCopilotWindowSizing {
    static let mainWindowFrameAutosaveName = "Live Interview CopilotMainWindow"
...
public struct LiveInterviewCopilotRootApp: App {
    ...
    public var body: some Scene {
        Window("Live Interview Copilot", id: "main") {
            ContentView(settings: settings)
                ...
                .onOpenURL { url in
                    guard let command = LiveInterviewCopilotDeepLink.parse(url) else { return }
        ...
        .defaultSize(
            width: LiveInterviewCopilotWindowSizing.mainWindowCollapsedMinSize.width,
            height: LiveInterviewCopilotWindowSizing.mainWindowCollapsedMinSize.height
        )
        .commands {
            CommandGroup(after: .appInfo) {
                ...
                Button("GitHub Repository...") {
                    if let url = URL(string: "https://github.com/jude864huang-debug/LiveInterviewCopilot") {
        ...
        .windowResizability(.contentMinSize)
        .defaultSize(
            width: LiveInterviewCopilotWindowSizing.notesWorkspaceMinSize.width,
            height: LiveInterviewCopilotWindowSizing.notesWorkspaceMinSize.height
        )
...
extension LiveInterviewCopilotRootApp {
...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private var isUITest: Bool {
        ProcessInfo.processInfo.environment["LIVE_INTERVIEW_COPILOT_UI_TEST"] != nil
    }
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        if !isUITest {
            for window in NSApp.windows where window.identifier?.rawValue == LiveInterviewCopilotRootApp.mainWindowID {
    ...
    func windowShouldClose(_ sender: NSWindow) -> Bool {
        ...
        let isMainWindow = sender.identifier?.rawValue == LiveInterviewCopilotRootApp.mainWindowID
    ...
    private func showBackgroundModeHintIfNeeded() {
        ...
        Task {
            ...
            content.title = "Live Interview Copilot is still running"
