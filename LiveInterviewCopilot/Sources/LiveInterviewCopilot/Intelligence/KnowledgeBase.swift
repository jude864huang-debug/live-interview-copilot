...
enum KnowledgeBaseIndexingStatus: Equatable, Sendable {
    ...
    var helpText: String {
        ...
        case .idle:
            return ""
        case .scanning:
            return "Live Interview Copilot is scanning your Knowledge Base folder so it can prepare meeting context."
        case .embedding:
            return "Live Interview Copilot is indexing your Knowledge Base folder so it can surface relevant context during meetings."
        case .completed:
            return "Live Interview Copilot finished indexing your Knowledge Base folder and can use it during meetings."
        case .blocked(let message), .failed(let message):
            return message
        }
    }
...
final class KnowledgeBase {
    ...
    private nonisolated static func cacheURL() -> URL {
        ...
        let dir = appSupport.appendingPathComponent("Live Interview Copilot")
