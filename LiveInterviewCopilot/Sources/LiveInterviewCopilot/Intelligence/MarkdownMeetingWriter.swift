...
/// Produces spec-compliant liveinterviewcopilot/v1 Markdown exports from session data.
///
...
enum MarkdownMeetingWriter {
    ...
    ///   - outputDirectory: The directory to write into (e.g. `~/Documents/LiveInterviewCopilot/`).
    ...
    static func buildFrontmatter(
        ...
        lines.append("schema: liveinterviewcopilot/v1")
        ...
        lines.append("x_liveinterviewcopilot_session: \(yamlQuote(metadata.sessionID))")
    ...
    private static func markdownContainsSessionID(_ url: URL, sessionID: String) -> Bool {
        ...
        return content.contains("x_liveinterviewcopilot_session: \(yamlQuote(sessionID))")
    }
