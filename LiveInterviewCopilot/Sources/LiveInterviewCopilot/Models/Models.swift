...
enum SessionTranscriptIssue: String, Codable, Sendable, Equatable {
    ...
    var emptyStateMessage: String {
        switch self {
        case .noAudioDetected:
            return "Live Interview Copilot did not capture usable microphone or system audio for this session."
        case .transcriptionProducedNoText:
            return "Live Interview Copilot captured audio for this session, but live transcription did not produce text."
        }
    }
