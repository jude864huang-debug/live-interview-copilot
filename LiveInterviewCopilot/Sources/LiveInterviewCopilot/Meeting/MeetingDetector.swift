...
final class CoreAudioSignalSource: AudioSignalSource, @unchecked Sendable {
    private let listenerQueue = DispatchQueue(label: "com.jude864huang.liveinterviewcopilot.mic-listener")
...
actor MeetingDetector {
    ...
    init(
        ...
        self.selfBundleID = Bundle.main.bundleIdentifier ?? "com.jude864huang.liveinterviewcopilot.app"
