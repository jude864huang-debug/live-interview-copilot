...
final class SystemAudioCapture: @unchecked Sendable {
    ...
    private let callbackQueue = DispatchQueue(
        label: "com.jude864huang.liveinterviewcopilot.system-audio",
        qos: .userInteractive
    )
    ...
    func bufferStream(outputDeviceID: AudioDeviceID? = nil) async throws -> CaptureStreams {
        ...
        for attempt in 0..<3 {
            ...
            tapDescription.name = "Live Interview Copilot System Audio"
            ...
            let aggregateDescription: [String: Any] = [
                kAudioAggregateDeviceNameKey: "Live Interview Copilot System Audio",
    ...
    enum CaptureError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .tapCreationFailed(let status):
                return "System audio capture could not start. Enable System Audio Recording for LiveInterviewCopilot in System Settings > Privacy & Security (OSStatus \(status))."
            case .aggregateDeviceCreationFailed(let status):
