...
final class MarkdownMeetingWriterTests: XCTestCase {
    ...
    func testFrontmatterContainsRequiredFields() {
        ...
        XCTAssertTrue(frontmatter.contains("schema: liveinterviewcopilot/v1"))
    ...
    func testFrontmatterIncludesSessionExtension() {
        ...
        XCTAssertTrue(frontmatter.contains("x_liveinterviewcopilot_session: \"session_2026-03-20_14-00-06\""))
    }
    ...
    func testBuildMarkdownProducesCompleteFile() {
        ...
        XCTAssertTrue(markdown.contains("schema: liveinterviewcopilot/v1"))
    ...
    func testWriteCreatesFileOnDisk() {
        let tmpDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("LiveInterviewCopilotTest-\(UUID().uuidString)")
        ...
        XCTAssertTrue(content.contains("schema: liveinterviewcopilot/v1"))
    }
