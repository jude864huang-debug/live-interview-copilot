...
final class DiagnosticsSupportTests: XCTestCase {
    func testDiagnosticsReportIncludesSettingsAndLogs() {
        let appInfo = DiagnosticsReportBuilder.AppInfo(
            ...
            bundleIdentifier: "com.jude864huang.liveinterviewcopilot.app",
            version: "1.56.0",
            build: "123",
        ...
        let report = DiagnosticsReportBuilder.buildText(
            ...
            unifiedLog: "2026-01-01 12:00:00.000 LiveInterviewCopilot[1:1] test line"
        )

        XCTAssertTrue(report.contains("Live Interview Copilot Diagnostics Export"))
        XCTAssertTrue(report.contains("Bundle ID: com.jude864huang.liveinterviewcopilot.app"))
