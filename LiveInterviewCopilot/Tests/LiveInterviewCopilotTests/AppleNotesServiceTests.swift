...
final class AppleNotesServiceTests: XCTestCase {
    ...
    func testNoteTitleWithMeetingTitle() {
        ...
        XCTAssertEqual(AppleNotesService.noteTitle(for: index), "[LiveInterviewCopilot] 2026-04-07 Sprint Planning")
    }

    func testNoteTitleWithoutTitle() {
        let index = makeSessionIndex(title: nil, date: date("2026-04-07"))
        XCTAssertEqual(AppleNotesService.noteTitle(for: index), "[LiveInterviewCopilot] 2026-04-07 Meeting")
    }
    ...
    func testNoteTitleTrimsWhitespace() {
        ...
        XCTAssertEqual(AppleNotesService.noteTitle(for: index), "[LiveInterviewCopilot] 2026-04-07 My Meeting")
    }
