...
final class WhatsNewControllerTests: XCTestCase {
    private func makeDefaults() -> UserDefaults {
        let suiteName = "com.jude864huang.liveinterviewcopilot.tests.whatsnew.\(UUID().uuidString)"
    ...
    private func makeRelease(version: String = "1.78.0") -> WhatsNewRelease {
        WhatsNewRelease(
            version: version,
            title: "LiveInterviewCopilot \(version)",
            body: "## Fixed\n- Notes render correctly.",
            htmlURL: URL(string: "https://github.com/jude864huang-debug/LiveInterviewCopilot/releases/tag/v\(version)")!
        )
    }
