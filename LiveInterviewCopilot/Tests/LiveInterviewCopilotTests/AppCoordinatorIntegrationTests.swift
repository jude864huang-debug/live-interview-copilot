...
final class AppCoordinatorIntegrationTests: XCTestCase {
    ...
    private func makeTestHarness(
        ...
        let suiteName = "com.jude864huang.liveinterviewcopilot.tests.\(UUID().uuidString)"
    ...
    private func makeTempDirs() -> (root: URL, notes: URL) {
        let root = URL(fileURLWithPath: NSTemporaryDirectory(), isDirectory: true)
            .appendingPathComponent("Live Interview CopilotCoordinatorTests", isDirectory: true)
